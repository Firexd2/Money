...
class BaseTemplateView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['configuration'] = self.request.user.settings.configurations.all().\
            get(name_url=self.kwargs['name_url'])
        return context


class StatTemplateView(BaseTemplateView):

    def get_context_data(self, **kwargs):
        context = super(StatTemplateView, self).get_context_data(**kwargs)
